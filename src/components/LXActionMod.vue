    ...
    >
      ...
      <el-row justify="space-between">
        <el-col
          ...
          @click="
            () => {
              recordItem.isFolded = !recordItem.isFolded;
            }
          "
      ...
      <div class="ruleFormClass" v-show="!recordItem.isFolded">
        <el-form label-position="right" label-width="35%" :model="recordItem.LXLoan" :rules="rules">
          ...
          <el-row justify="space-around">
            <el-col :xs="24" :span="10">
              <el-form-item label="借款到期时间:" inline prop="loanEndTime">
                <el-date-picker
                  @change="loanEndTimeChange(recordKey)"
            ...
            <el-col :xs="24" :span="10">
              <el-form-item label="期内利率种类:" v-if="recordItem.LXLoan.rateRadio">
                <el-select
                  ...
                  @change="
                    rateSelectChange(
                      recordItem.LXLoan.rateSelectValue,
                      recordKey
                    )
                  "
                >
          ...
          <el-row
            ...
            v-if="
              recordItem.LXLoan.stableRateInputShow &&
              recordItem.LXLoan.rateRadio
            "
          >
            <el-col :xs="24" :span="10">
          ...
          <el-row
            justify="space-around"
            v-if="
              recordItem.LXLoan.oneYearLPRItemShow &&
              recordItem.LXLoan.rateRadio
            "
          >
            <el-col :xs="24" :span="10">
          ...
          <el-row
            justify="space-around"
            v-if="
              recordItem.LXLoan.fiveYearLPRItemShow &&
              recordItem.LXLoan.rateRadio
            "
          >
            <el-col :xs="24" :span="10">
            ...
            <el-col :xs="24" :span="10">
              <el-form-item label="逾期利率种类:" v-if="recordItem.LXLoan.overdueRateRadio">
                <el-select
                  ...
                  placeholder="请选择"
                  @change="
                    overdueRateSelectChange(
                      recordItem.LXLoan.overdueRateSelectValue,
                      recordKey
                    )
                  "
                >
          ...
          <el-row
            justify="space-around"
            v-if="
              recordItem.LXLoan.overdueStableRateInputShow &&
              recordItem.LXLoan.overdueRateRadio
            "
          >
            <el-col :xs="24" :span="10">
              <el-form-item label="逾期年利率：">
          ...
          <el-row
            justify="space-around"
            v-if="
              recordItem.LXLoan.overdueOneYearLPRItemShow &&
              recordItem.LXLoan.overdueRateRadio
            "
          >
            <el-col :xs="24" :span="10">
          ...
          <el-row
            justify="space-around"
            v-if="
              recordItem.LXLoan.overdueFiveYearLPRItemShow &&
              recordItem.LXLoan.overdueRateRadio
            "
          >
            <el-col :xs="24" :span="10">
        ...
        <!-- 结算容器 -->
        <el-row>
          <LXBalanceModVue :loanKey="recordKey"></LXBalanceModVue>
        </el-row>
      </div>
